...
outdir = "../../khi_null_point_overleaf/images/"
...
ENERGY_HEIGHT_MULT=1.0

print(FONTSIZE)
_fig, axis = create_axes(3, height_mult=ENERGY_HEIGHT_MULT)
...
```{python}
maxes = [5e-6, 1e-4, 5e-2]
multipliers = [1,5, 1000]
...
#     start = time.time()
    ...
    iso_rate_dic[t] = calc_reconnection_rate(fli_data_folder, timedump, extents, h)
