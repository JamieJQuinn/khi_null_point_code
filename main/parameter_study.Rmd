...
plot_mach_numbers(eta_4_switching, "mach_numbers_eta_4_swi.pdf", [0.5, 5])
```

```{python}
eta_4_isotropic = ["v-5r-4-isotropic", "v-4r-4-isotropic", "v-3r-4-isotropic"]
plot_mach_numbers(eta_4_isotropic, "mach_numbers_eta_4_iso.pdf", [0.5, 5])
```
...
plot_mach_numbers(eta_3_isotropic, "mach_numbers_eta_3_iso.pdf", [0.5, 5])
```
